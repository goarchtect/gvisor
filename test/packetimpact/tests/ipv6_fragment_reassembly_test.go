...
func TestIPv6FragmentReassembly(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			ipPayloadLen: 3000,
			fragments: []fragmentInfo{
				{offset: 0, size: 1000, more: true},
				{offset: 1000, size: 1000, more: true},
				{offset: 1000, size: 1000, more: true},
				{offset: 2000, size: 1000, more: false},
			},
			expectReply: true,
		},
		{
		...
		},
		{
			...
			fragments: []fragmentInfo{
				{offset: 0, size: 1000, more: true},
				{offset: 1512, size: 1000, more: true},
				{offset: 1000, size: 1000, more: true},
				{offset: 2000, size: 1000, more: false},
			},
			expectReply: false,
